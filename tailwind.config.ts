  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        // iOS Native Color System Integration
        ios: {
          blue: 'var(--ios-blue)',
          'blue-light': 'var(--ios-blue-light)',
          'blue-dark': 'var(--ios-blue-dark)',
          'blue-subtle': 'var(--ios-blue-subtle)',
          'blue-background': 'var(--ios-blue-background)',
          red: 'var(--ios-red)',
          ...
          gray6: 'var(--ios-gray6)',
          label: 'var(--ios-label)',
          'secondary-label': 'var(--ios-secondaryLabel)',
          'tertiary-label': 'var(--ios-tertiaryLabel)',
          'quaternary-label': 'var(--ios-quaternaryLabel)',
          'system-background': 'var(--ios-systemBackground)',
          'secondary-system-background': 'var(--ios-secondarySystemBackground)',
          'tertiary-system-background': 'var(--ios-tertiarySystemBackground)',
          'system-fill': 'var(--ios-systemFill)',
          'secondary-system-fill': 'var(--ios-secondarySystemFill)',
          'tertiary-system-fill': 'var(--ios-tertiarySystemFill)',
          'quaternary-system-fill': 'var(--ios-quaternarySystemFill)',
          separator: 'var(--ios-separator)',
          'opaque-separator': 'var(--ios-opaqueSeparator)',
        },
      },
      borderRadius: {
        lg: 'var(--radius)',
