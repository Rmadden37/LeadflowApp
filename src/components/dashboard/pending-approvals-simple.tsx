...
function PendingApprovalsSimple() {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        <div className="p-3 rounded-xl bg-gradient-to-br from-orange-500/20 to-amber-500/10 ring-1 ring-orange-500/20">
      ...
      <div className="grid gap-6">
        {pendingApprovals.map((approval) => (
          <div key={approval.id} className="frosted-glass-card">
            <div className="p-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <span className="inline-flex items-center px-3 py-1 rounded-lg text-xs font-medium bg-orange-500/10 text-orange-400 border border-orange-500/20 backdrop-blur-sm">
                ...
                <div className="flex flex-col gap-4 min-w-[200px]">
                  ...
                  <div className="flex flex-col sm:flex-row gap-2">
                    <Button
                      ...
                      className="flex-1 bg-red-500/10 border border-red-500/20 text-red-400 hover:bg-red-500/20 hover:border-red-500/30 backdrop-blur-sm transition-all duration-200"
                    >
                    ...
                    <Button
                      ...
                      disabled={processingApproval === approval.id}
                      className="flex-1 bg-green-500/10 border border-green-500/20 text-green-400 hover:bg-green-500/20 hover:border-green-500/30 backdrop-blur-sm transition-all duration-200"
                    >
                      {processingApproval === approval.id ? (
                        <Loader2 className="h-4 w-4 animate-spin mr-2" />
                      ) : (
...
export default PendingApprovalsSimple;
