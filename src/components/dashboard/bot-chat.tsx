  ...
  useEffect(() => {
    if (isOpen && messages.length === 0 && user) {
      const welcomeMessage: Message = {
        id: 'welcome',
        content: `Hello ${user.displayName || 'there'}! 🤖 I'm your LeadFlow Analytics Assistant, ready to help you analyze your sales data and discover insights. I can provide performance analytics, generate visualizations, and answer questions about your team's metrics. What would you like to explore?`,
        isBot: true,
        timestamp: new Date(),
      };
...
useEffect(() => {
  ...
  const clearChat = () => {
    ...
    if (user) {
      const welcomeMessage: Message = {
        id: 'welcome-new',
        content: `Chat cleared! 🤖 I'm your Analytics Assistant, ready to help you with fresh insights and analysis. What would you like to explore, ${user.displayName || 'there'}?`,
        isBot: true,
        timestamp: new Date(),
      };
      setMessages([welcomeMessage]);
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[700px] h-[700px] flex flex-col p-0 bg-gradient-to-b from-blue-50 to-indigo-50 dark:from-slate-900 dark:to-slate-800 border-2 border-blue-200 dark:border-blue-500/30 dark:card-glass">
        <DialogHeader className="px-6 py-4 border-b border-blue-200 dark:border-blue-500/20 bg-gradient-to-r from-blue-100 to-indigo-100 dark:from-slate-800/50 dark:to-slate-700/50">
                ...
                <div className="flex gap-3 justify-start">
                  ...
                  <div className="bg-gradient-to-br from-amber-100 to-orange-100 dark:from-slate-800/70 dark:to-slate-700/70 rounded-lg px-3 py-2 border border-amber-200 dark:border-turquoise/20 dark:glow-turquoise">
                    <div className="flex items-center gap-2 text-amber-800 dark:text-gray-300">
                      ...
                      <span className="text-xs italic">AI is analyzing your data...</span>
                    </div>
                  </div>
                </div>
              )}
