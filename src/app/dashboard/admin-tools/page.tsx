                          ...
                          onChange={(e) => setEditingTeam({ 
                            ...
                            settings: { 
                              ...
                              workingHours: { 
                                ...
                                start: e.target.value,
                                end: editingTeam.settings?.workingHours?.end || "22:00",
                                timezone: editingTeam.settings?.workingHours?.timezone || "America/Los_Angeles"
                              }
                            }
                          })}
                        />
                        ...
                        <Input
                          ...
                          onChange={(e) => setEditingTeam({ 
                            ...
                            settings: { 
                              ...editingTeam.settings, 
                              workingHours: { 
                                start: editingTeam.settings?.workingHours?.start || "07:00",
                                end: e.target.value,
                                timezone: editingTeam.settings?.workingHours?.timezone || "America/Los_Angeles"
                              }
                            }
